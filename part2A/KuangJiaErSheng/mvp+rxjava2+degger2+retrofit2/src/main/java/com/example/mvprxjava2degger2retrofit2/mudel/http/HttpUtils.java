...
public class HttpUtils {
    ...
    public static Retrofit getRetrofit(String url, final Context context){
        ...
        SeviserRec service = retrofit.create(SeviserRec.class);
    ...
    public static SeviserRec  createWeatherService(Context context){
            //返回接口的实现类
        return getRetrofit(url1,context).create(SeviserRec.class);
    }
